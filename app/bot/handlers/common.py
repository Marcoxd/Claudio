...
def welcome_text() -> str:
    ...
    return (
        f"👋 <b>{name}</b> — {settings.app_tagline}\n\n"
        "Anota tus gastos como te salga natural:\n"
        "• <i>«almuerzo 12.50 con la visa»</i>\n"
        "• 🎤 una nota de voz\n"
        "• 📷 la foto del recibo\n"
        "• 📄 el PDF de la factura\n\n"
        "Yo entiendo el monto, la categoría, el medio de pago, los diferidos y "
        "hasta con quién dividiste la cuenta.\n\n"
        "<b>Comandos</b>\n"
...
• Manda la foto del recibo y toca <b>👥 Dividir cuenta → por ítems</b>
  para marcar qué consumió cada quien (el IVA y la propina se prorratean solos).
...
<b>Tarjetas</b>
• <code>/tarjetas</code> te dice cuánto cae en cada corte y cuándo vence.
• Los diferidos se reparten mes a mes automáticamente.

<b>Recibos</b>
Foto o PDF: leo comercio, fecha, total e ítems. Puedes mandar la foto con
un texto al pie, por ejemplo <i>«con la visa, dividido con Ana»</i>.
"""
